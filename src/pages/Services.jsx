  ...
  return (
    <div className="font-serif">
      <div
        ...
        className="animate-rightSlider leading-10 z-0 relative h-[90vh] w-full after:z-[-1] after:h-full after:w-full after:left-0 after:top-0 after:bg-[rgba(0,0,0,0.8)] after:absolute"
      >
